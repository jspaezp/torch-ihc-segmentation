...
From: https://raw.githubusercontent.com/bermanmaxim/LovaszSoftmax/master/pytorch/lovasz_losses.py
"""
...
class LovaszSoftmaxWithLogits(LovaszSoftmax):
    def __init__(self, classes="present", per_image=False, ignore=None):
        super().__init__(classes=classes, per_image=per_image, ignore=ignore)

    def forward(self, logits, labels):
        probs = F.softmax(logits, dim=1)
        return super().forward(probs, labels)
